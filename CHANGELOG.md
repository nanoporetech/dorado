...
1. Scoring parameters for barcode classification have been updated to support a new classification algorithm. Older scoring config files will no longer be compatible.
