...
if (HDF5_USE_STATIC_LIBRARIES AND NOT WIN32)
    ...
    set(STATIC_HDF5_C_LIBRARIES)
    foreach (_lib IN LISTS HDF5_C_LIBRARIES)
        if (_lib MATCHES "sz" AND STATIC_SZ_LIB)
            list(APPEND STATIC_HDF5_C_LIBRARIES ${STATIC_SZ_LIB})
            # libsz.a depends on libaec.a, if it exists.
            if (STATIC_AEC_LIB)
                list(APPEND STATIC_HDF5_C_LIBRARIES ${STATIC_AEC_LIB})
            endif()
        else()
            list(APPEND STATIC_HDF5_C_LIBRARIES ${_lib})
        endif()
    endforeach()
    target_link_libraries(HDF5Wrapper INTERFACE ${STATIC_HDF5_C_LIBRARIES})
else()
