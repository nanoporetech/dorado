...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux" OR WIN32)
    ...
    if(BUILD_KOI_FROM_SOURCE)
        ...
        if(NOT EXISTS ${KOI_DIR})
            ...
            execute_process(COMMAND git checkout add5986250e7980572f30598c766b80f6e2c6b19 WORKING_DIRECTORY ${KOI_DIR})
            execute_process(COMMAND git submodule update WORKING_DIRECTORY ${KOI_DIR})
        endif()
        ...
        if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
            download_and_extract(https://nanoporetech.box.com/shared/static/y1frdyukibywuq44isq6jn2a2b8au5ud.gz koi_lib)
            file(GLOB KOI_DIR "${DORADO_3RD_PARTY}/koi_lib/*")
            set(KOI_LIBRARIES ${KOI_DIR}/lib/libkoi.a)
        elseif(WIN32)
            download_and_extract(https://nanoporetech.box.com/shared/static/obwsimbpl46gxx744xdevt3gwd4nblgo.zip koi_lib)
            file(GLOB KOI_DIR "${DORADO_3RD_PARTY}/koi_lib/*")
