...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    ...
    set(POD5_LIBRARIES
      ...
      ${DORADO_3RD_PARTY}/${POD5_DIR}/lib64/libboost_filesystem.a
...
elseif(APPLE)
    ...
    set(POD5_LIBRARIES
      ...
      ${DORADO_3RD_PARTY}/${POD5_DIR}/lib/libboost_filesystem.a
...
elseif(WIN32)
    ...
    set(POD5_LIBRARIES
      ...
      ${DORADO_3RD_PARTY}/${POD5_DIR}/lib/libboost_filesystem.lib
