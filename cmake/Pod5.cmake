...
set(POD5_DIR pod5-${POD5_VERSION}-${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR})
...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64*|^arm*")
      set(POD5_URL "${POD5_REPO}/releases/download/${POD5_VERSION}/pod5-file-format-${POD5_VERSION}-linux-arm64.tar.gz")
    else()
