...
if(DEFINED DORADO_LIBTORCH_DIR)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        if(CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64*|^arm*")
            if(CUDAToolkit_VERSION VERSION_GREATER_EQUAL 13.0)
                set(TORCH_URL ${DORADO_CDN_URL}/torch-2.9.0.3-ont-CUDA-13.0-linux-aarch64.zip)
                set(TORCH_PATCH_SUFFIX .2-ont-CUDA-13.0)
    ...
    elseif(APPLE)
        set(TORCH_URL ${DORADO_CDN_URL}/torch-2.9.0.2-ont-macos-m1.zip)
        set(TORCH_PATCH_SUFFIX .2-ont)
