...
set(CUDNN_LIBRARY_PATH ${CMAKE_CURRENT_SOURCE_DIR}/dorado/3rdparty/fake_cudnn)
set(CUDNN_INCLUDE_PATH ${CMAKE_CURRENT_SOURCE_DIR}/dorado/3rdparty/fake_cudnn)
...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    if(DORADO_USING_OLD_CPP_ABI)
        ...
        set(TORCH_LIB "${CMAKE_CURRENT_SOURCE_DIR}/dorado/3rdparty/torch-no-cxx11-abi-${TORCH_VERSION}-${CMAKE_SYSTEM_NAME}/libtorch")
    else()
        set(TORCH_URL https://download.pytorch.org/libtorch/cu113/libtorch-cxx11-abi-shared-with-deps-${TORCH_VERSION}%2Bcu113.zip)
        set(TORCH_LIB "${CMAKE_CURRENT_SOURCE_DIR}/dorado/3rdparty/torch-${TORCH_VERSION}-${CMAKE_SYSTEM_NAME}/libtorch")
    endif()
elseif(APPLE)
    ...
    set(TORCH_LIB "${CMAKE_CURRENT_SOURCE_DIR}/dorado/3rdparty/torch-${TORCH_VERSION}-${CMAKE_SYSTEM_NAME}/torch")
elseif(WIN32)
