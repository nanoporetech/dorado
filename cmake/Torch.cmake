...
if(DEFINED DORADO_LIBTORCH_DIR)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        if(CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64*|^arm*")
            if(CUDAToolkit_VERSION VERSION_GREATER_EQUAL 13.0)
                set(TORCH_URL ${DORADO_CDN_URL}/torch-2.9.0.0-ont-CUDA-13.0-linux-aarch64.zip)
                set(TORCH_PATCH_SUFFIX .0-ont-CUDA-13.0)
                set(TORCH_HASH "be1e322417cd04329e52e1506239a9ea67696ef683c576154f63b3703bb40821")
    ...
    elseif(APPLE)
        ...
        set(TORCH_HASH "fb2e66c56bb46c706f35eb432f51321b900df2bfdfce75f0629ed470ef9830c2")
        set(TORCH_LIB_SUFFIX "libtorch")
    elseif(WIN32)
        if(CUDAToolkit_VERSION VERSION_GREATER_EQUAL 13.0)
