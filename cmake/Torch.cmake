...
if(DEFINED DORADO_LIBTORCH_DIR)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        if(CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64*|^arm*")
            if(CUDAToolkit_VERSION VERSION_GREATER_EQUAL 13.0)
                set(TORCH_URL ${DORADO_CDN_URL}/torch-2.10.0.0-ont-CUDA-13.0-linux-aarch64.zip)
                set(TORCH_PATCH_SUFFIX .0-ont-CUDA-13.0)
                set(TORCH_HASH "aa854e3301a063f89e0c0acd6741a5152ba919aa8797f43af5bf03df45d2def2")
        ...
        elseif(CUDAToolkit_VERSION VERSION_GREATER_EQUAL 13.0)
            set(TORCH_URL ${DORADO_CDN_URL}/torch-2.10.0.0-ont-CUDA-13.0-linux-x64-cxx11-abi.zip)
            set(TORCH_PATCH_SUFFIX .0-ont-CUDA-13.0)
            set(TORCH_HASH "1d7f6ec65e97824cf8af4ecc3ac15433da689d4051a09ef80be391e66fca234f")
            set(TORCH_LIB_SUFFIX "libtorch")
    ...
    elseif(APPLE)
        set(TORCH_URL ${DORADO_CDN_URL}/torch-2.7.1.1-ont-macos-m1.zip)
        set(TORCH_PATCH_SUFFIX .1-ont)
        set(TORCH_HASH "3a787e1735165ec2aaefdf78f3677af17c169adf5d26e9396f6d75fe25797a75")
        set(TORCH_LIB_SUFFIX "libtorch")
    elseif(WIN32)
        if(CUDAToolkit_VERSION VERSION_GREATER_EQUAL 13.0)
            set(TORCH_URL ${DORADO_CDN_URL}/torch-2.10.0.0-ont-windows.zip)
            set(TORCH_PATCH_SUFFIX .0-ont)
            set(TORCH_HASH "cf83d4c668ddffccb99c8baaba6679749fa335e36e76b12b1ae525559cbb348b")
            set(TORCH_LIB_SUFFIX "libtorch")
        else()
