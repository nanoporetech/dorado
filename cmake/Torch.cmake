...
if(DEFINED DORADO_LIBTORCH_DIR)
            ...
            if (TRY_USING_STATIC_TORCH_LIB)
                if(DORADO_USING_OLD_CPP_ABI)
                    if(${CUDAToolkit_VERSION} VERSION_GREATER_EQUAL 12.8)
                        set(TORCH_URL ${DORADO_CDN_URL}/torch-${TORCH_VERSION}-CUDA-12.8-linux-x64-ont-pre-cxx11.zip)
                        set(TORCH_HASH "1d3c17d5b30ab4b422477604392a4fe57427c47bda40bbfcc37fc273fd0dfdaf")
                    else()
                    ...
                    if(${CUDAToolkit_VERSION} VERSION_GREATER_EQUAL 12.8)
                        set(TORCH_URL ${DORADO_CDN_URL}/torch-${TORCH_VERSION}-CUDA-12.8-linux-x64-ont-cxx11-abi.zip)
                        set(TORCH_HASH "26c99b4a12068504ff28d3a746798193fce7e1a5b620a9133440623708e29044")
                    else()
    ...
    elseif(WIN32)
        ...
        if (TRY_USING_STATIC_TORCH_LIB)
            ...
            set(TORCH_URL ${DORADO_CDN_URL}/torch-2.6.0.tmp-Windows-ont.zip)
            set(TORCH_PATCH_SUFFIX -ont.0)
            #set(TORCH_HASH "bb496ebc3766b39ee76120a3a0b988a9494ddf4af61f42ca552cb173d1cb6b75")
            set(TORCH_HASH "3f3fdd24135ed01338453ebc4980a2962d345e094e956a294b16e5138d55bd71")
            set(TORCH_LIB_SUFFIX "/libtorch")
            set(USING_STATIC_TORCH_LIB TRUE)
