...
int MetalCaller::benchmark_batch_sizes(const CRFModelConfig &model_config,
    ...
    const int max_batch_size = static_cast<int>(
            std::clamp(utils::pad_to(available_memory / (2 * decode_buffer_size_per_elem),
