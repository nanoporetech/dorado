...
public: 
    ...
    ~ScalerNode();
    //Read Trimming function (removes some initial part of the raw read).
...
private:
    ...
    ReadSink& m_sink; //ReadSink to consume scaled reads. Typically this will be a Basecaller Node.
