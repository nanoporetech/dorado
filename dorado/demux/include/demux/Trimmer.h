...
class Trimmer {
public:
    static BamPtr trim_sequence(bam1_t* irecord, std::pair<int, int> interval, bool is_rna);
    static void trim_sequence(SimplexRead& read, std::pair<int, int> interval, bool is_rna);
