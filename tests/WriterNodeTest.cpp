    ...
    void generate_bam(HtsFile::OutputMode mode, int num_threads) {
        ...
        std::vector<std::unique_ptr<hts_writer::IWriter>> writers;
        {
            ...
            auto hts_writer_builder = hts_writer::BasecallHtsFileWriterBuilder(
                    emit_fastq, emit_sam, false, false, out_dir, num_threads, progress_cb,
        ...
        reader.read(*pipeline, 1000, false, nullptr, false);
...
CATCH_TEST_CASE("HtsFileWriterTest: Read and write FASTQ with tag", TEST_GROUP) {
    ...
    std::vector<std::unique_ptr<hts_writer::IWriter>> writers;
    {
        ...
        auto hts_writer_builder = hts_writer::BasecallHtsFileWriterBuilder(
                true, false, false, false, out_dir, 1, progress_cb, description_cb, GPU_NAMES);
