...
Test index-size of 100000bp. There will be several chunks containing this many reads: (1) 1, (2) 2, (3) 2, (4) 1.
  $ rm -rf out; mkdir -p out
  > in_reads=${TEST_DATA_DIR}/read_correction/reads.fq
  > model_var=${MODEL_DIR:+--model-path ${MODEL_DIR}}
  > ${DORADO_BIN} correct ${in_reads} -t 4 ${model_var} -v --index-size 100000 > out/out.fasta 2> out/out.fasta.stderr
